...
class DeepResUp(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, upsample=True):
        ...
        self.batch_norm_b4 = nn.BatchNorm2d(num_features=out_channels)
        ...
        self.batch_norm_b8 = nn.BatchNorm2d(num_features=out_channels)
        self.relu_b9 = nn.ReLU()
        self.conv_b10 = spectral_norm(nn.Conv2d(out_channels, out_channels, kernel_size=3, padding='same'))
        nn.init.orthogonal_(self.conv_b10.weight)
        self.batch_norm_b11 = nn.BatchNorm2d(num_features=out_channels)
